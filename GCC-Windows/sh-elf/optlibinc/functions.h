...
extern __inline__ void set_cr(int cr) __attribute__ ((always_inline));
extern __inline__ int get_cr(void) __attribute__ ((always_inline));
extern __inline__ void set_imask(unsigned long mask) __attribute__ ((always_inline));
extern __inline__ int get_imask(void) __attribute__ ((always_inline));
extern __inline__ void set_vbr(void *base) __attribute__ ((always_inline));
extern __inline__ void *get_vbr(void) __attribute__ ((always_inline));


extern __inline__ void *get_gbr(void) __attribute__ ((always_inline));
extern __inline__ void set_gbr(void *base) __attribute__ ((always_inline));
...
extern __inline__ void set_imask(unsigned long mask)__attribute__ ((always_inline));
extern __inline__ int get_imask()__attribute__ ((always_inline));
